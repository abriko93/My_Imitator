...
#define RCC_PIN9 RCC_AHB1Periph_GPIOD
#define RCC_PIN10 RCC_AHB1Periph_GPIOD
#define RCC_PIN11 RCC_AHB1Periph_GPIOD
#define RCC_DIOD1 RCC_AHB1Periph_GPIOD
#define RCC_DIOD2 RCC_AHB1Periph_GPIOG
